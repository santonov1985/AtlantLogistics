...
var hljs = function () {
    ...
    const R = t, y = r, {nodeStream: O, mergeStreams: k} = i, M = Symbol("nomatch");
    return function (t) {
        ...
        function m(e, t, a, s) {
            ...
            }(E), N = "", y = s || _, O = {}, k = new f.__emitter(f);
            !function () {
            ...
            try {
                ...
                return x(o.substr(S)), k.closeAllNodes(), k.finalize(), N = k.toHTML(), {
                    relevance: I,
                    value: N,
                    language: e,
                    illegal: !1,
        ...
        function E(e) {
            ...
            const r = n.textContent, a = t ? b(t, r, !0) : v(r), i = O(n);
            if (i.length) {
