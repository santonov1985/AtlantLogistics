    ...
    <div class="card shadow-sm">
        <div class="card-body">
            <div class="d-flex justify-content-between mb-3">
                <div>
                    <h5>Создание информации о компании:</h5>
                </div>
                {{--Кнопка добавить--}}
                        ...
                        <div class="row">
                            <div class="col-md-8">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="title" placeholder="Пример: О Компании" class="form-control" required>
                                </div>
                            </div>
                        </div>
                        {{--Заголовок--}}
...
{{--                                    <img id="tiding_image" src="#" alt="" class="mt-3">--}}
{{--                                </div>--}}
{{--                            </div>--}}
{{--                        </div>--}}
                        {{--Картинка--}}
                        ...
                        <div class="row">
                            <div class="col-md-8">
                                <div class="form-group">
                                    ...
                                    <label>Контент:</label>
                                    <div id="texteditor" style="width: 100%; height: 400px">
                                        {{ old('description') }}
                                    </div>
                                </div>
                            </div>
